...
mmSetParamValue("::renderer::renderMode", "Ambient_Occlusion")
mmSetParamValue("::renderer::ambient occlusion::enableLighting", "true")
...
mmSetParamValue("::dat::filename", [[..\tests\data\sphererenderer\test_xyz_double_rgba_ushort.mmpld]])
mmRenderNextFrame()
